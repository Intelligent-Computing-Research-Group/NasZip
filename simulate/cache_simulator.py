...
if __name__ == "__main__":
    ...
    idx_path=gen_idx_name(dataset_name, current_idx_type, graph_degree=args.graph_degree, ef_construction=args.ef_construction)
    ...
    for cache_size in [500, 1000, 2000, 4000]:
        for it in range(2, 23):
    ...
    csv_path = os.path.join(result_dir, "cache_hit_rate.csv")
    ...
    print(f"Saved cache hit rate results to {csv_path}")
