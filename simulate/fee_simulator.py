...
if __name__ == "__main__":
    ...
    for dataset_name, ef_search, gd in zip(["SIFT", "GIST", "GloVe", "Wiki"],
                                        [40, 120, 450, 280], [32, 64, 16, 32]):
        ...
        for k in Ks:
            ...
            if not high_performance:
                ...
                print(f"Early stop frequency saved to {os.path.join(early_stop_dir, f'{dataset_name}.npy')}")
